...
# Base da API Pública do DataJud
...
class TribunalDatajud(str, Enum):
    ...
    (e TJDFT), usando a sigla que aparece nos aliases da API:
...
class DatajudClient:
    ...
    def _normalizar_cnj(numero_cnj: str) -> str:
        """Remove pontuação da numeração CNJ, deixando apenas dígitos."""
        return (
            numero_cnj.replace("-", "")
            .replace(".", "")
            .replace("_", "")
